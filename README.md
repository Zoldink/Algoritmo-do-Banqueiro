...
Este repositório contém a implementação do Algoritmo do Banqueiro, desenvolvida para a disciplina de Sistemas Operacionais na PUC Minas - Campus Betim. O projeto foca na prevenção de deadlocks em sistemas multithreaded.
